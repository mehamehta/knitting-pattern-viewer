...
<div id="page-toolbar">
  ...
  <span id="cs-step-badge" style="font-size:0.82rem;color:#b0897a;white-space:nowrap;">Step — / ${TOTAL_STEPS}</span>
  ...
  <span id="cs-rep-badge" style="display:none;font-size:0.9rem;font-weight:700;color:#d7a13f;white-space:nowrap;"></span>
  <span id="cs-rep-label" style="display:none;font-size:0.75rem;color:#b0897a;white-space:nowrap;"></span>
</div>`;
...
const PIP_CSS = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  #cs-pip-close { cursor: pointer; padding: 0 4px; color: #6d4a45; }
  #cs-pip-close:hover { color: #f2e7d5; }
  #cs-pip-content { flex: 1; padding: 10px 12px; overflow-y: auto; line-height: 1.6; }
  #cs-pip-rep { display: none; padding: 0 12px 6px; font-size: 0.75rem; color: #d7a13f; flex-shrink: 0; }
  ...
  .cs-pip-nav:hover { background: #63303d; color: #f2e7d5; }
  #cs-pip-badge { font-size: 0.72rem; color: #b0897a; }
  strong { color: #e8dcc4; }
  em { color: #c9a08f; font-style: italic; }
  .pip-lbl { font-weight: 700; color: #e8dcc4; }
  .gloss-link { border-bottom: 1px dotted currentColor; }
  #cs-pip-slt-btn { cursor: pointer; padding: 0 5px; color: #6d4a45; font-size: 0.7rem; border-radius: 3px; }
  #cs-pip-slt-btn:hover { color: #b98f7d; background: #562634; }
